        ...
        for path, types, allowed in self.paths:
            if request.path.startswith(path) and content_type in types:
                ...
                for domain in allowed:
                    ...
                    response['Access-Control-Allow-Headers'] = 'Authorization, Content-Type, Origin, X-Requested-With, X-Requested-By, *'
                    response['Access-Control-Allow-Credentials'] = "true"
                    response['Access-Control-Expose-Headers'] = 'Authorization, Content-Type, Origin, X-Requested-With, X-Requested-By, *'
                break
        return response
